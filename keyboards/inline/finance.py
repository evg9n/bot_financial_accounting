...
CATEGORIES_KREDIT = (
    ...
    "Путешествие", "Красота/Здоровье", "ЖКХ/Аренда", "Кредит/Долг/Налог", 
    "Кафе/Ресторан", "Маркетплейс", "Побаловать себя)", "Вредная привычка", 
    "Супермаркет", "Транспорт/Авто", "Работа", "Прочее",
)
